...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://backendforbuildbigger.appspot.com/_ah/api/";
  ...
  public class GetJokes extends MyApiRequest<com.example.user.myapplication.backend.myApi.model.MyBean> {
